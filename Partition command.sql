...
insert into ineuron_course values ('machine learning', 101, 'ML', "this is ML course" ,'2019-07-07',3540,'sudhanshu',2019),
...
select ('fsds' ,110,2021) < ('MERN',116,2023)
select ('a') > ('b')
